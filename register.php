...
if (!isset($_POST['username'], $_POST['password'], $_POST['email'])) {
	...
	exit('Please complete the registration form10!');
}
...
//bindes to the prepared statement
...
if ($stmt->num_rows > 0) {
	...
	$activate_link = 'https://Christianvillads.tech/activate.php?email=' . $_POST['email'] . '&code=' . $uniqid;
